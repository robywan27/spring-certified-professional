...
public class RewardNetworkTest {
    ...
    @BeforeEach
    public void setUp() {
//        System.setProperty("spring.profiles.active", "development,production"); // to activate profiles
...
//        rewardNetwork = context.getBean("rewardNetwork", RewardNetwork.class);
        // RewardNetwork bean found in the app context, including all of its dependencies
